...
A Terraform module to deploy the GitHub Actions Runner Scale Set Controller on Amazon EKS cluster.
...
| <a name="requirement_utils"></a> [utils](#requirement\_utils) | ~> 0 |
...
| <a name="input_helm_chart_name"></a> [helm\_chart\_name](#input\_helm\_chart\_name) | Helm chart name to be installed | `string` | `"gha-runner-scale-set-controller"` | no |
| <a name="input_helm_chart_version"></a> [helm\_chart\_version](#input\_helm\_chart\_version) | Version of the Helm chart | `string` | `"0.7.0"` | no |
...
| <a name="input_helm_release_name"></a> [helm\_release\_name](#input\_helm\_release\_name) | Helm release name | `string` | `"gha-rs-controller"` | no |
...
| <a name="input_helm_repo_url"></a> [helm\_repo\_url](#input\_helm\_repo\_url) | Helm repository | `string` | `"ghcr.io/actions/actions-runner-controller-charts"` | no |
...
| <a name="input_irsa_role_name_prefix"></a> [irsa\_role\_name\_prefix](#input\_irsa\_role\_name\_prefix) | The IRSA role name prefix for GitHub Actions Runner Scale Set Controller | `string` | `"gha-rs-irsa"` | no |
| <a name="input_irsa_tags"></a> [irsa\_tags](#input\_irsa\_tags) | IRSA resources tags | `map(string)` | `{}` | no |
| <a name="input_namespace"></a> [namespace](#input\_namespace) | The K8s namespace in which the GitHub Actions Runner Scale Set Controller service account has been created | `string` | `"github-actions-runner-scale-set"` | no |
...
| <a name="input_service_account_name"></a> [service\_account\_name](#input\_service\_account\_name) | The K8s GitHub Actions Runner Scale Set Controller service account name | `string` | `"github-actions-runner-scale-set-controller"` | no |
| <a name="input_settings"></a> [settings](#input\_settings) | Additional helm sets which will be passed to the Helm chart values, see https://hub.helm.sh/charts/stable/gha-runner-scale-set-controller | `map(any)` | `{}` | no |
| <a name="input_values"></a> [values](#input\_values) | Additional yaml encoded values which will be passed to the Helm chart, see https://github.com/actions/actions-runner-controller/tree/master/charts/gha-runner-scale-set-controller | `string` | `""` | no |
